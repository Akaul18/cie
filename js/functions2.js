...
{
	t_username = $("#t_username").val();	
	if(t_username == "" || isNaN(t_username) == false){
		alert("Enter valid name.");return false;
	}

	t_phone = $("#t_phone").val();
	if((isNaN(t_phone) == true)||(t_phone == "")||(t_phone.length<10)){
		alert("Enter valid phone number.");return false;
	}

	t_address = $("#t_address").val();
	if(t_address.length < 1){
		alert("Enter a valid address.");return false;
	}

	t_comp = $("#t_comp").val();	
	if(t_comp.length < 1){
		alert("Enter a valid company name.");return false;
	}
	t_iname = $("#t_iname").val();	
	if(t_iname == "" || isNaN(t_iname) == false){
		alert("Enter valid institute name.");return false;
	}
	...
	t_ino = $("#t_ino").val();	
	if((isNaN(t_ino) == true)||(t_ino == "")){
		alert("Enter valid institute number.");return false;
	}

	t_uni = $("#t_uni").val();	
	if(t_uni.length < 1){
		alert("Enter a university name.");return false;
	}

	t_profile = $("#t_profile").val();
	if(t_profile == "" || isNaN(t_profile) == false){
		alert("Enter valid profile.");return false;
	}
